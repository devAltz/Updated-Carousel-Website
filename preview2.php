...
<head>
    ...
    <style>
        ...
        .image-carousel-item:hover {
            transform: scale(0.99); /* Slight scale effect on hover */
            box-shadow: 0 0 15px rgba(0,0,0,0.2); /* Shadow effect on hover */
        }
        .image-carousel-item.active {
            border: 3px solid #3498db; /* Highlight active item */
        }
        .image-carousel-item:after {
        ...
        .image-carousel-item:hover:after {
                ...
                <div class="image-carousel">
                    <div class="image-carousel-inner" id="image-carousel-inner">
                        <?php foreach ($_SESSION["carousel_items"] as $index => $item): ?>
                            <div class="image-carousel-item <?php echo $index === 0 ? 'active' : ''; ?>" data-slide="<?php echo $index; ?>">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (document.querySelector('.carousel-item')) {
                ...
                const imageCarouselItems = document.querySelectorAll('.image-carousel-item');
                ...
                function showSlide(index) {
                    ...
                    // Update active class for visual indication
                    imageCarouselItems.forEach((item, i) => {
                ...
                // Function to show details in the main carousel
                function showDetails(index) {
                    // Update bottom carousel only
                ...
                // Add click event to the images in the top carousel
                ...
                // Auto-advance the top carousel every 3 seconds
                let autoSlideInterval = setInterval(() => {
                    showSlide(currentSlide + 1);
                    // Note: We don't automatically update the details carousel
                }, 3000);
